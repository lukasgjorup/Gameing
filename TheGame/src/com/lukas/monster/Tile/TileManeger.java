...
import com.lukas.monster.main.Gamepanel;
import com.lukas.monster.main.Map;
...
public class TileManeger {
    ...
    private final HashMap<String, BufferedImage> stringImageHashMap = new HashMap<>();
    Gamepanel gp;
    Map map;
    Tile[][] tile;
    short[][] check;
    ...
    public void getTileImage() throws IOException {
        // Load tile images
        grassImage = getReadImage("/Tiles/GRASS.png");
        waterImage = getReadImage("/Tiles/WATER.png");
        stoneImage = getReadImage("/Tiles/stone2.png");
    ...
    void assignWaterEdgeSprite(Tile tile) throws IOException {
        ...
        if (tile.water2 && tile.water4 && tile.water6 && tile.water8){
         tile.image = getReadImage("/Tiles/W1.png");
        } else if (tile.water2 && tile.water4 && tile.water6) {
            tile.image = getReadImage("/Tiles/W2.png");
        } else if (tile.water2 && tile.water4 && tile.water8) {
            tile.image = getReadImage("/Tiles/W3.png");
        } else if (tile.water2 && tile.water6 && tile.water8) {
            tile.image = getReadImage("/Tiles/W4.png");
        } else if (tile.water4 && tile.water6 && tile.water8) {
            tile.image = getReadImage("/Tiles/W5.png");
        } else if (tile.water2 && tile.water4 && tile.water9) {
            tile.image = getReadImage("/Tiles/Wrt9.png");
        }else if (tile.water6 && tile.water2 && tile.water7) {
            tile.image = getReadImage("/Tiles/Wlt7.png");
        }else if (tile.water8 && tile.water4 && tile.water3) {
            tile.image = getReadImage("/Tiles/Wlb3.png");
        }else if (tile.water8 && tile.water6 && tile.water1) {
            tile.image = getReadImage("/Tiles/Wrb1.png");
        }else if (tile.water8 && tile.water4) {
            tile.image = getReadImage("/Tiles/Wrb.png");
        } else if (tile.water2 && tile.water4) {
            tile.image = getReadImage("/Tiles/Wrt.png");
        }else if (tile.water2 && tile.water6){
            tile.image = getReadImage("/Tiles/Wlt.png");
        } else if (tile.water8 && tile.water6){
            tile.image = getReadImage("/Tiles/Wlb.png");
        }else if (tile.water8 && tile.water2){
            tile.image = getReadImage("/Tiles/Wtb.png");
        }else if (tile.water4 && tile.water6){
            tile.image = getReadImage("/Tiles/Wlr.png");
        }else if (tile.water8 && tile.water1 && tile.water3){
            tile.image = getReadImage("/Tiles/W138.png");
        }else if (tile.water2 && tile.water7 && tile.water9){
            tile.image = getReadImage("/Tiles/W279.png");
        }else if (tile.water4 && tile.water3 && tile.water9){
            tile.image = getReadImage("/Tiles/W349.png");
        }else if (tile.water1 && tile.water6 && tile.water7){
            tile.image = getReadImage("/Tiles/W167.png");
        }else if (tile.water2 && tile.water7){
            tile.image = getReadImage("/Tiles/W27.png");
        }else if (tile.water1 && tile.water8){
            tile.image = getReadImage("/Tiles/W18.png");
        }else if (tile.water3 && tile.water8){
            tile.image = getReadImage("/Tiles/W38.png");
        }else if (tile.water2 && tile.water9){
            tile.image = getReadImage("/Tiles/W29.png");
        }else if (tile.water3 && tile.water4){
            tile.image = getReadImage("/Tiles/W34.png");
        }else if (tile.water4 && tile.water9){
            tile.image = getReadImage("/Tiles/W49.png");
        }else if (tile.water1 && tile.water6){
            tile.image = getReadImage("/Tiles/W16.png");
        }else if (tile.water6 && tile.water7){
            tile.image = getReadImage("/Tiles/W67.png");
        }else if (tile.water8){
            tile.image = getReadImage("/Tiles/Wb.png");
        }else if (tile.water6){
            tile.image = getReadImage("/Tiles/Wr.png");
        }else if (tile.water4){
            tile.image = getReadImage("/Tiles/Wl.png");
        }else if (tile.water2){
            tile.image = getReadImage("/Tiles/Wt.png");
        }else if (tile.water1 && tile.water3 && tile.water7 && tile.water9){
            tile.image = getReadImage("/Tiles/W1379.png");
        }else if (tile.water1 && tile.water3 && tile.water7){
            tile.image = getReadImage("/Tiles/W137.png");
        }else if (tile.water1 && tile.water3 && tile.water9){
            tile.image = getReadImage("/Tiles/W139.png");
        }else if (tile.water1 && tile.water7 && tile.water9){
            tile.image = getReadImage("/Tiles/W179.png");
        }else if (tile.water3 && tile.water7 && tile.water9){
            tile.image = getReadImage("/Tiles/W379.png");
        }else if (tile.water1 && tile.water9){
            tile.image = getReadImage("/Tiles/W19.png");
        }else if (tile.water3 && tile.water7){
            tile.image = getReadImage("/Tiles/W37.png");
        }else if (tile.water1 && tile.water3){
            tile.image = getReadImage("/Tiles/W13.png");
        }else if (tile.water9 && tile.water3){
            tile.image = getReadImage("/Tiles/W39.png");
        }else if (tile.water9 && tile.water7){
            tile.image = getReadImage("/Tiles/W79.png");
        }else if (tile.water1 && tile.water7){
            tile.image = getReadImage("/Tiles/W17.png");
        }else if (tile.water1){
            tile.image = getReadImage("/Tiles/W1111.png");
        }else if (tile.water3){
            tile.image = getReadImage("/Tiles/W3333.png");
        }else if (tile.water7){
            tile.image = getReadImage("/Tiles/W7777.png");
        }else if (tile.water9){
            tile.image = getReadImage("/Tiles/W9999.png");
        }
